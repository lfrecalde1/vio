...
class ConfigEuRoC(object):
    def __init__(self):
        ...
        self.gyro_noise = 0.001 ** 2
        self.acc_noise = 0.01 ** 2
        self.gyro_bias_noise = 0.001 ** 2
        self.acc_bias_noise = 0.01 ** 2
        self.observation_noise = 0.01 ** 2
        ...
        self.gyro_bias_cov = 1e-4
        self.acc_bias_cov = 1e-2
        self.extrinsic_rotation_cov = 3.0462e-4
        self.extrinsic_translation_cov = 1e-4
